...
.method static constructor <clinit>()V
    ...
    const-string v0, "Venom - HEQS LTE"

    sput-object v0, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->Tag:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->setTitle(I)V
...
.method private setPreferedNetworkMode(I)V
    ...
    sget-object v1, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->Tag:Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->getModeValue(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->mContext:Landroid/content/Context;
...
.method protected getCurrentState()Lcom/android/systemui/statusbar/powerwidget/Toggle$State;
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->getModeValue(I)Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->booleanToState(Z)Lcom/android/systemui/statusbar/powerwidget/Toggle$State;
...
.method protected onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    sget-object v0, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->Tag:Ljava/lang/String;

    const-string v1, "OnReceive"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->getCurrentState()Lcom/android/systemui/statusbar/powerwidget/Toggle$State;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->setCurrentState(Lcom/android/systemui/statusbar/powerwidget/Toggle$State;)V
...
.method protected onToggleClick()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->setCurrentState(Lcom/android/systemui/statusbar/powerwidget/Toggle$State;)V

    :goto_1
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->setPreferedNetworkMode(I)V
...
.method protected onToggleLongClick()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/LTEButton;->startActivity(Landroid/content/Intent;)V
