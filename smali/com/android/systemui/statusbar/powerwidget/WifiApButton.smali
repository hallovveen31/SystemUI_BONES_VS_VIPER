...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->setTitle(I)V
...
.method protected getCurrentState()Lcom/android/systemui/statusbar/powerwidget/Toggle$State;
    ...
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->convertState(I)Lcom/android/systemui/statusbar/powerwidget/Toggle$State;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->convertState(I)Lcom/android/systemui/statusbar/powerwidget/Toggle$State;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->setCurrentState(Lcom/android/systemui/statusbar/powerwidget/Toggle$State;)V
...
.method protected onToggleClick()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->getCurrentState()Lcom/android/systemui/statusbar/powerwidget/Toggle$State;
    ...
    :goto_2
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->setCurrentState(Lcom/android/systemui/statusbar/powerwidget/Toggle$State;)V

    new-instance v2, Lcom/android/systemui/statusbar/powerwidget/WifiApButton$1;

    invoke-direct {v2, p0, v1, v0}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton$1;-><init>(Lcom/android/systemui/statusbar/powerwidget/WifiApButton;Landroid/net/wifi/WifiManager;Z)V

    new-array v3, v3, [Ljava/lang/Void;

    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method protected onToggleLongClick()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/powerwidget/WifiApButton;->startActivity(Landroid/content/Intent;)V
